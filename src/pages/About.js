...
const About = () => {
  return (
    <main>
      ...
      <div className="main">
        <section
          className="module bg-dark-60 about-page-header"
            ...
            <div className="col-xs-12 col-md-6 col-md-offset-6 side-image-text">
              <div className="row">
                <div className="col-sm-12">
                  <h2 className="module-title font-alt align-left">Our office</h2>
        ...
        <section className="module" id="services">
          <div className="container">
            <div className="row">
              <div className="col-sm-6 col-sm-offset-3">
                <h2 className="module-title font-alt">Our Advantages</h2>
            ...
            <div className="row multi-columns-row">
              ...
              <div className="col-md-3 col-sm-6 col-xs-12">
                <div className="features-item">
                  ...
                  <h3 className="features-title font-alt">Highly customizable</h3>
                  <p>
                    Careful attention to detail and clean, well structured code
                    ensures a smooth user experience for all your visitors.
                  </p>
