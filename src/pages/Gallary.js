...
const Gallary = () => {
  return (
    <main>
      <div class="main">
        <section
          class="module bg-dark-60 gallery-page-header parallax-bg"
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_1.jpg"
                      title="Title 1"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/1.jpg"
                        alt="Gallery Image 1"
                      />
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_3.jpg"
                      title="Title 2"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/3.jpg"
                        alt="Gallery Image 2"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_12.jpg"
                      title="Title 3"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/12.jpg"
                        alt="Gallery Image 3"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_13.jpg"
                      title="Title 4"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/13.jpg"
                        alt="Gallery Image 4"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_19.jpg"
                      title="Title 5"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/19.jpg"
                        alt="Gallery Image 5"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_37.jpg"
                      title="Title 6"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/37.jpg"
                        alt="Gallery Image 6"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_46.jpg"
                      title="Title 7"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/46.jpg"
                        alt="Gallery Image 7"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_48.jpg"
                      title="Title 8"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/48.jpg"
                        alt="Gallery Image 8"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="gallery-item">
                  <div class="gallery-image">
                    <a
                      class="gallery"
                      href="assets/images/gallery/big/big_33.jpg"
                      title="Title 9"
                    >
                      <img
                        src="assets/images/gallery/thumbnail/full_3/33.jpg"
                        alt="Gallery Image 9"
                      />
                      <div class="gallery-caption">
                        <div class="gallery-icon">
