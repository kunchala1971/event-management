...
const Services = () => {
  return (
    <main>
      <div class="main">
        <section
          class="module bg-dark-60 service-page-header"
          data-background="assets/images/services_bg.jpg"
        >
          <div class="container">
            <div class="row">
        ...
        <section class="module pt-0 pb-0" id="about">
          <div class="row position-relative m-0">
            <div
              class="col-xs-12 col-md-6 side-image"
            ...
            <div class="row multi-columns-row post-columns">
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  ...
                  <div class="post-more">
                    <a class="more-link" href="service1 copy 3.html">
                      Read more
                    </a>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  ...
                  <div class="post-more">
                    <a class="more-link" href="service1 copy 2.html">
                      Read more
                    </a>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  ...
                  <div class="post-more">
                    <a class="more-link" href="service1 copy.html">
                      Read more
                    </a>
                  </div>
                </div>
